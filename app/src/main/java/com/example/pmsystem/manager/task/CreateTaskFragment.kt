...
class CreateTaskFragment : Fragment(),CreateTaskContract.View {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = LayoutInflater.from(context).inflate(R.layout.fragment_create_task,container,false)
        ...
        view.btn_create.setOnClickListener {
            ...
            createTaskPresenter.buttonClicked(project_id,task_name,task_status,task_desc,start_date,end_date)
        }
        return view
    }
